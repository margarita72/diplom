...
@section('title','Сформированный пакет')
@section('content')
    <!-- breadcrumb -->
    <div class="container">
                                ...
                                <tr class="table_head">
                                    ...
                                    <tr class="table_row">
                                        ...
                                        <td class="column-1">
                                            ...
                                            <div class="how-itemcart1">
                                                ...
                                                <img src="../storage/products/June2019/RcyUAiGVm2YUSAMJuIcP.jpg" alt="IMG">
                                            </div>
                                        </td>

                                        <td class="column-2">
                                            Умный электрочайник Redmond SkyKettle G201S
                                        </td>

                                        <td class="column-3">₽2290</td>
                                        <td class="column-4">
                                    ...
                                    <td class="column-1">
                                        ...
                                        <div class="how-itemcart1">
                                            ...
                                            <img src="../storage/products/June2019/G1xSkUy6SjBit9YoAtEr.jpg" alt="IMG">
                                        </div>
                                    </td>

                                    <td class="column-2">
                                        Умная мультиварка Redmond SkyCooker M800S (черный)
                                    </td>

                                    <td class="column-3">₽8990</td>
                                    <td class="column-4">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                            <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
                                                <i class="fs-16 zmdi zmdi-minus"></i>
                                    ...
                                    <td class="column-1">
                                        ...
                                        <div class="how-itemcart1">
                                            ...
                                            <img src="../storage/products/January2019/mJQUnqkiNcg226kRnVr4.jpg" alt="IMG">
                                        </div>
                                    </td>

                                    <td class="column-2">
                                        Комплект умный дом Rubetek RK-3512, видеоконтроль и безопасность
                                    </td>

                                    <td class="column-3">₽10000</td>
                                    <td class="column-4">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                            <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
                                                <i class="fs-16 zmdi zmdi-minus"></i>
                                    ...
                                    <td class="column-1">
                                        ...
                                        <div class="how-itemcart1">
                                            ...
                                            <img src="../storage/products/June2019/x5YZFONHigxkPHwe2ZkW.jpg" alt="IMG">
                                        </div>
                                    </td>

                                    <td class="column-2">
                                        Датчик открытия Elgato Eve Door & Window (белый)
                                    </td>

                                    <td class="column-3">₽4890</td>
                                    <td class="column-4">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                            <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
                                                <i class="fs-16 zmdi zmdi-minus"></i>
                                            ...
                                            <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value='2'>
